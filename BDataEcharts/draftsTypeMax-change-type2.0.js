...
function onCreatedEventCallBack(currentComponentInstance, ...arg) {
    ...
    var app = {
            ...
            "month":'',
            tab: function () {
                var url = "http://xxx.xxx.xx.xxx:xxxx/server/house/getFinancialTargetTable?year="
            ...
            chartzcfzldbfx: function (chartid) {
                ...
                http.post("http://xxx.xxx.xx.xxx:xxxx/prod-api/dataModel/executeQuery", {
                    id: 84,
            ...
            chartzjqk: function (chartid) {
                ...
                http.get("http://xxx.xxx.xx.xxx:xxxx/server/fund/countBalanceGroupByMonth",
                        ...
                        chart.on('click', function (params) {
                            ...
                            if (params.seriesName == '贷款') {
                                ...
                                var param = {
                                    ...
                                    current: 1,
                                    size: 10,
                                    url: "http://xxx.xxx.xx.xxx:xxxx/server/fund/getBankAndBalanceDetails"
                                };
            ...
            chartjzsyyhkhs: function (chartid) {
                http.get("http://xxx.xxx.xx.xxx:xxxx/server/fund/openBank",
                    { headers: { 'token': _e, "content-type": "application/json", "agent": "Nexus" } })
                    .then(res => {
                        ...
                        chart.on('click', function (params) {
                            ...
                            var param = {
                                ...
                                current: 1,
                                size: 10,
                                url: "http://xxx.xxx.xx.xxx:xxxx/server/fund/getOpenBankDetails"
                            };
            ...
            chartylnl: function (chartid) {
                http.post("http://xxx.xxx.xx.xxx:xxxx/server/p/cw-ylnl", {
                    kjbm: '0002',
                    hybm: '0000',
                    month: this.month,
                    year: this.year,
            ...
            chartyynl: function (chartid) {
                http.post("http://xxx.xxx.xx.xxx:xxxx/server/p/cw-yynl", {
                    kjbm: '0002',
                    hybm: '0000',
                    month: this.month,
                    year: this.year,
            ...
            chartcznl: function (chartid) {
                http.post("http://xxx.xxx.xx.xxx:xxxx/server/p/cw-cznl", {
                    kjbm: '0002',
                    hybm: '0000',
                    month: this.month,
                    year: this.year,
            ...
            chartfznl: function (chartid) {
                http.post("http://xxx.xxx.xx.xxx:xxxx/server/p/cw-fznl", {
                    kjbm: '0002',
                    hybm: '0000',
                    month: this.month,
                    year: this.year,
    ...
    if (param == undefined || param == null) {
        var url = "http://xxx.xxx.xx.xxx:xxxx/server/house/getCurrent"
        http.get(url, { headers: { 'token': _e, "content-type": "application/json", "agent": "Nexus" } }
        ).then(res => {
            var data = res.data;
            param = {
